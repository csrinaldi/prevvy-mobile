...
var app = {
    ...
    // http://192.168.0.93:8888/prevvy.html
    url: 'https://frontend.prod.prevvy.co',
    ...
    receivedEvent: function (id) {
        ...
        app.browser = cordova.InAppBrowser.open(this.url, '_blank', 'location=yes,zoom=no,hidden=yes,clearsessioncache=yes,clearcache=yes');
    ...
    onLoadStart: function(event) {
        ...
        /*if ( event.url.endsWith('launch.html')) {
            app.browser.hide();

            setTimeout(function () {
                var text = JSON.stringify([{value: "HOLA"}]);
